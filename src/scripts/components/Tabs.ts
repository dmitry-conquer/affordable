...
class Tabs {
  ...
  private bgsElements: NodeListOf<HTMLElement>;
  ...
  constructor(rootElement: HTMLElement) {
    ...
    this.bgsElements = this.rootElement.querySelectorAll("[data-tabs-bgs] img") as NodeListOf<HTMLElement>;
  ...
  private updateUI(): void {
    ...
    this.rootElement.style.backgroundImage = `url(${this.bgsElements[activeTabIndex].getAttribute("src")})`;
